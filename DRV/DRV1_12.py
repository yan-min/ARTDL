...
#from predict_anything import predict_final
...
def select_best_test(executed_matrix,candidate_set):
    ...
    for key, candidate in candidate_set.items():
        ...
        dis=EMDDistances(candidate_matrix,executed_matrix[1:])
        dis = np.array(dis)
...
with open('./ART_result/DRV1_12_'+now_time+'art.csv', 'wb',0) as csvfile:
    ...
    # caculate F-meatures, the counts of failures
        ...
        error_count = 1
#         failure_set = []
#         for file in os.listdir("./error0109"):
